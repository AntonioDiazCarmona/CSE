...
world_map = {
    ...
    "COBBLE_STONE_STATUE": {
        ...
        'DESCRIPTION': "You are at the cobble stone statue now try to see what is the top of the coblestone"
                       " statue with no head by placing the stool that you collected from the backyard"
                       " and try climbing it to see what was"
                       " at the top of the no head statue",  # you check here and theres a key to mansion
        'PATHS': {
            'EAST': "V2MANSION_DOOR"
        }
    },
    ...
    "V2MANSION_DOOR": {
        ...
        # here is where you would open the mansion door
        'PATHS': {
    ...
    "INSIDE_MANSION": {
        ...
        # you opened the mansion door  so you got inside the mansion
        'PATHS': {
            '': ""
        }
    }
