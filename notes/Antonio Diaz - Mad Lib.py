...
print("Because of what was behind the door we whent to an underground passage way that lead to  %s" % noun8)
...
print("when heard I heard the loud noice i woke up and realized it was all a dream")